...
IMGDIRPROCESSED[0]  = r'./images/imagesbooks1/'
IMGDIRPROCESSED[1]  = r'./images/imagesbooks2/'
IMGDIRPROCESSED[2]  = r'./images/imagesbooks_FEXT/'         # Warp in foreground BB 1
IMGDIRPROCESSED[3]  = r'./images/imagesbooks_FEXTwarp/'     # Warp on foreground BB 2
IMGDIRPROCESSED[4]  = r'./images/imagesbooks_F_ALLBB/'      # original img with overlayed BB 
IMGDIRPROCESSED[5]  = r'./images/imagesbooks_S320/'         # Resize to w=320 (50%)
...
IMGDIRPROCESSED[13]  = r'./images/imagesbooks_R270/'         # Rotate by 270 deg 
IMGDIRPROCESSED[14]  = r'./images/imagesbooks_DENOISE1/'         # Denoise  
IMGDIRPROCESSED[15]  = r'./images/imagesbooks_DENOISE2/'         # Denoise  
IMGDIRPROCESSED[16]  = r'./images/imagesbooks_CTYING/'        # increased  contrast
