...
elbow = KneeLocator( list(range(1,101)), wcss, S=1.0, curve='convex', direction='decreasing')
...
HSVtree = KDTree(YA , metric='manhattan')
...
# print the list of files from ind
mydataHSV.iloc[ ind[0].tolist()]['file']